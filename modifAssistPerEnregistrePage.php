...
include("header.php"); 
$id=$_REQUEST['idRecup'];
$query="select * from assistanceper where id=$id";
 ...
 while($val = mysql_fetch_array($result))
{
	...
	$titrePageAncien=$val['titre'];

	
		$query2="update assistanceper set titre='$title' where id=$id ";
...
echo "<P><A HREF='modifAssistPer.php?numBut=$id#'>Retour sur la page précédente</A><P>";
?>
</CENTER>
</BODY>
</HTML>
